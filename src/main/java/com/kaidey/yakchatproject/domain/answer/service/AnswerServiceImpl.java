...
import com.kaidey.yakchatproject.global.exception.AnswerErrorCode;
...
public class AnswerServiceImpl implements AnswerService {
	...
	public List<QuestionWithAnswersDto> getAnswersByUserIdByCreatedAtDesc(Long userId) {
		...
		// 질문 조회
		List<QuestionWithAnswersDto> questions = questionRepository.findTop5ByIdInOrderByCreatedAtDesc(questionIds)
			.stream()
