...
public class OcrValidationServiceImpl implements OcrValidationService {
	private static final List<String> PHARMACY_STUDENT_KEYWORDS = Arrays.asList("약학과", "약학대학", "약대", "약학", "Pharmacy",
		"College of Pharmacy");
	private static final List<String> PHARMACY_LICENSE_KEYWORDS = Arrays.asList("약사", "면허증", "보건복지부", "면허",
		"Pharmacist");
	private static final List<String> STUDENT_CARD_KEYWORDS = Arrays.asList("학생증", "학번", "Student ID", "학과", "대학교",
		"University");
