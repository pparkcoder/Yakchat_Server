...
public class CommonErrorCode extends ErrorCode{
    ...
    public static final CommonErrorCode INVALID_REQUEST = new CommonErrorCode
    ...
    public static final CommonErrorCode NO_AUTHORITY = new CommonErrorCode
            (HttpStatus.FORBIDDEN, "NO_AUTHORITY", "권한이 없습니다.");
